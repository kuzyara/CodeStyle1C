...
- [6. ПРАВИЛА РАБОТЫ С ТРАНЗАКЦИЯМИ](#6-правила-работы-с-транзакциями)
  ...
  - [6.3.2 Когда перед вызовом оператора ВызватьИсклюение; не следует делать запись в журнал регистрации](#632-когда-перед-вызовом-оператора-вызватьисклюение-не-следует-делать-запись-в-журнал-регистрации)
...
### 6.3.2 Когда перед вызовом оператора ВызватьИсклюение; не следует делать запись в журнал регистрации
