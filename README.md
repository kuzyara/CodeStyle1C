...
* __Документы__
Имена документов, напротив, даются в единственном числе. Например: *ЗаказПокупателя*, *ПеремещениеТоваров*, *Анкета*. Если в имени документа присутствуют частицы или союзы, то их можно опустить.
