...
## 11. Сложные условия
"Тяжелые" многострочные условия затрудняют понимание кода. _todo: добавить более выразительный пример, из текущего непонятно в чём он плох._

Подозрительный код _непонятно что тут подозрительного, нормальный код_
```bsl
Если Тип = "Структура"
    ИЛИ Тип = "Строка"
    ИЛИ Тип = "Число" Тогда
